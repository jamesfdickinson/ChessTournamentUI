...
export default {
  ...
  components: {},
  data() {
    let id = this.$route.params.id; //https://cardsjd.com/cribbage/embedded/?room=T6R4T27&name=Jimmy&email=jimmy@jdsoftwarellc.com&id=
    let tournamentId = this.$route.params.tournament;
    let spectate = this.$route.params.spectate;
    let gameRoomLink =
      "https://cardsjd.com/cribbage/embedded/?room=[room]&name=[name]&email=[email]&id=[id]&spectate=[spectate]&avatar=[avatar]";
